...
export default function ManageTasksPage() {
  ...
  const handleGenerateWithAi = async () => {
    setIsLoadingAi(true);
    try {
      const newTasks = await generateNewTaskLibrary();
      setTasks(newTasks.tasks);
      toast({
        title: "AI Refresh Complete!",
        description: "The task library has been updated with new tasks from AI.",
      });
    } catch (error) {
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will replace the entire current task library with 20 new
