...
- **Withdrawal Address Added/Updated**: "The withdrawal address has been saved."
- **Withdrawal Address Deleted**: "The withdrawal address has been deleted."
- **Multiple Addresses Disabled**: "The admin has disabled adding more than one withdrawal address."
...
### Recharge
- **Confirm Deposit Title**: "Confirm Deposit"
- **Confirm Deposit Description**: "Please ensure you have already sent your funds to the selected address. Submitting a request without sending funds may result in account restrictions."
- **Withdrawal Address Required Title**: "Withdrawal Address Required"
- **Withdrawal Address Required Description**: "For security, you must set up at least one withdrawal address before you can make a recharge request. Please go to the Withdrawal panel to add an address."

### Withdrawal
- **Pending Request Title**: "Pending Request"
- **Pending Request Description**: "You already have a withdrawal request pending. Please wait for it to be processed before submitting a new one."
- **Monthly Limit Reached Title**: "Monthly Limit Reached"
- **Monthly Limit Reached Description**: "You have reached your monthly withdrawal limit of [X] for Level [Y]. Please try again next month."
- **Minimum Amount Not Met Title**: "Minimum Withdrawal Amount"
- **Minimum Amount Not Met Description**: "The minimum withdrawal amount for Level [Y] is $[Amount]. Please enter a higher amount."
- **Withdrawal Restricted Title**: "Withdrawal Restricted"
- **Withdrawal Restricted Description**: The content of this message is managed in **Admin -> System Settings**.
`;
